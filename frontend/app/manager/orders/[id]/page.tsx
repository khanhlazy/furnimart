...
export default function ManagerOrderDetailPage() {
  ...
  const { user, isLoading: authLoading } = useRequireAuth({ requiredRole: ['manager', 'admin'] });

  const { data: order, isLoading, error } = useQuery<Order>(
    ['order', orderId],
    () => orderService.getById(orderId),
    { enabled: !!orderId && !authLoading && (user?.role === 'manager' || user?.role === 'admin') }
  );
      ...
      <div className="page-shell">
        ...
        <div className="flex-1 section-shell flex items-center justify-center">
          <div className="empty-state">
            ...
            <Link href="/manager/orders" className="inline-link">
    ...
    <div className="page-shell">
      ...
      <header className="hero-banner">
        <div className="section-shell relative z-10">
          <Link href="/manager/orders" className="inline-flex items-center gap-2 text-white hover:text-white/90 mb-4">
