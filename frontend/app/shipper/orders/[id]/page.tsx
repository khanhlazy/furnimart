...
export default function ShipperOrderDetailPage() {
  ...
  const { user, isLoading: authLoading } = useRequireAuth({ requiredRole: ['shipper', 'admin'] });
  const queryClient = useQueryClient();

  const { data: order, isLoading, error } = useQuery<Order>(
    ['order', orderId],
    () => orderService.getById(orderId),
    { enabled: !!orderId && !authLoading && (user?.role === 'shipper' || user?.role === 'admin') }
  );
      ...
      <div className="page-shell">
        ...
        <div className="flex-1 section-shell flex items-center justify-center">
          <div className="empty-state">
            ...
            <Link href="/shipper/orders" className="inline-link">
    ...
    <div className="page-shell">
      ...
      <header className="hero-banner">
        <div className="section-shell relative z-10">
          <Link href="/shipper/orders" className="inline-flex items-center gap-2 text-white hover:text-white/90 mb-4">
